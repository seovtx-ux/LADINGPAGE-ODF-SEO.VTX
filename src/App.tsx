        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-3 md:gap-6">
            {[
              ...
              { name: 'VNPT', theme: 'text-blue-400 border-blue-400/30 bg-blue-400/10 hover:border-blue-400 hover:shadow-[0_0_15px_rgba(96,165,250,0.4)]' },
              { name: 'FPT Telecom', theme: 'text-orange-500 border-orange-500/30 bg-orange-500/10 hover:border-orange-500 hover:shadow-[0_0_15px_rgba(249,115,22,0.4)]' },
              { name: 'Mobifone', theme: 'text-cyan-400 border-cyan-400/30 bg-cyan-400/10 hover:border-cyan-400 hover:shadow-[0_0_15px_rgba(34,211,238,0.4)]' },
              { name: 'CMC Telecom', theme: 'text-indigo-400 border-indigo-400/30 bg-indigo-400/10 hover:border-indigo-400 hover:shadow-[0_0_15px_rgba(129,140,248,0.4)]' }
            ].map((partner, idx) => (
              <div key={idx} className={`px-4 py-2 sm:px-8 sm:py-4 rounded-xl border transition-all duration-300 text-lg sm:text-xl font-bold font-serif flex items-center justify-center min-w-[140px] sm:min-w-[200px] cursor-default ${partner.theme}`}>
                {partner.name}
              </div>
            ))}
          </div>
